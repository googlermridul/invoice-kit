...
class InvoicesCubit extends Cubit<InvoicesState> {
  ...
  Future<void> load() async {
    ...
    emit(state.copyWith(loading: false, invoices: sorted, defaultCurrency: profile?.defaultCurrency));
  }
  ...
  Future<Invoice> createDraft({required String clientId, String currency = 'USD'}) async {
    final profile = await businessRepo.load();
